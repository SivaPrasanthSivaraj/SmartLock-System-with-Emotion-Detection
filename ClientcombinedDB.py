...
# cameraId=3
# WSS_URI = f"wss://687d-2401-4900-4df7-6a7b-89a2-d308-7d2c-cecc.ngrok-free.app/camera/{cameraId}"  # e.g. wss://your-ngrok-url/camera/CAM_ID
...
#                             print(f"[CAMERA] {CAM_ID} unlocked by {name}.")
